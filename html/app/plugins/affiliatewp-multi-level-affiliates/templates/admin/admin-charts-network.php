...
$charts_affiliate_id = apply_filters( 'mla_admin_chart_affiliate', $charts_affiliate_id, $filter_vars );
if( empty($charts_affiliate_id) ) :
?>

<div class="mla_charts_admin_message">
<?php _e( 'Please select an affiliate above', 'affiliatewp-multi-level-affiliates' ); ?>
</div>
...
//echo '<pre>'; print_r($network_children); echo '</pre>';
...
<?php do_action( 'mla_admin_before_chart', $charts_affiliate_id );?>
...
jQuery(function() {
  ...
  /*var datasource = <?php //echo json_encode($network_children) ?>;*/
