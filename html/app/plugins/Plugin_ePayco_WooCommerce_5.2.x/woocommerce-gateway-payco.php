        ...
        class WC_ePayco extends WC_Payment_Gateway
        {
            ...
            public function receipt_page($order_id)
            {
               ...
               // var_dump($productName);
                ...
                ',trim($this->epayco_publickey),$testMode,$descripcion, $descripcion, $order->get_id(),$currency,$order->get_total(),$tax,$base_tax,$basedCountry, $external, $redirect_url,$confirm_url,$email_billing,$name_billing,$address_billing,$this->epayco_lang,$phone_billing);
